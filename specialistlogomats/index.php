        ...
        <div class="grid_Select_Mat">
            ...
            <div>
                ...
                foreach ($productData as $key => $x) {
                    ...
                    echo '<p><span style="margin-right:5px">' . $x['bullets'][0]['icon'] . '</span>' . $x['bullets'][0]['point'] . '</p>';
                    echo '<p><span style="margin-right:5px">' . $x['features']['area'] . '</span>' . $x['features']['print'] . '</p>';
                ...
                <div id="ex1" class="modal" style="padding: 0px 0px;">
                    <div class="modal_flex">
                        <div class="modal_Content">
                            <p class="title" ></p>
                            <p class="subtitle"></p>
                            <ul class="features">
                                <li><span><i class="fa-regular fa-eye"></i></span> Free Preview Visual</li>
                                <li><span><i class="fa-solid fa-scissors"></i></span> Made to Measure Sizing</li>
                                <li><span><i class="fa-solid fa-face-tired"></i></span> High-Quality Rubber Backing</li>
                                <li><span><i class="fa-solid fa-washing-machine"></i></span>  Machine Washable</li>
                                <li><span><i class="fa-solid fa-truck"></i></span>  Fast Delivery</li>
                                <li><span><i class="fa-regular fa-flag"></i></span>  UK Made</li>
                                <li><span><i class="fa-solid fa-ballot-check"></i></span>  Choice of Backing Finish</li>
                            </ul>
                            <div>
                                <p>
                                A soft, rug material mat available in over 300 backing colours - we're able to print full colour, high-fidelity designs directly onto our Deep dye logo mats. The resolution of our printing is so good that we can even print your custom photographs onto a mat for you.
                                </p>
                                <p>These floor mats are perfect for the reception or welcome area of a business or institution.</p>
                                <p>Deep dye logo rugs are super easy to clean too - vacuum, steam clean or even throw them into a washing machine at 30ºc (provided the mat fits.)</p>
                            </div>
                        </div>
                        <div class="modal_img">
